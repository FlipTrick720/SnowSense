...
public class SkiResortController {
	...
	public ResponseEntity<Map<String, String>> scrapeSkiResort() {
		...
		response.put(
			"message",
			"Ski resort data scraped and saved to database. Check terminal for details."
		);
	...
	public ResponseEntity<List<SkiResortLift>> getSkiResortLiftsForResort(
		@PathVariable Long resortId
	) {
		return ResponseEntity.ok(
			_skiResortService.getSkiResortLiftDataForResort(resortId)
		);
	}
	...
	public ResponseEntity<List<SkiResortSlope>> getSkiResortSlopesForResort(
		@PathVariable Long resortId
	) {
		return ResponseEntity.ok(
			_skiResortService.getSkiResortSlopeDataForResort(resortId)
		);
	}
}
